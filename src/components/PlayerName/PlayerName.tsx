...
const PlayerName = () => {
    ...
    const handleIsEdit = () => setIsPlayerEdit(!isPlayerEdit);
    const handlePlayerName = (e: React.ChangeEvent<HTMLInputElement>) => setPlayerName(e.target.value);
        ...
        <>
            {isPlayerEdit ?
                (
                    ...
                    <form onSubmit={handleSubmit} className={styles.nameInput}>
